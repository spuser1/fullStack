    ...
    "resources": [
      {
        ...
        "method": "GET",
        "url": "/api/v1/orders?filter={filter}&limit={limit}&offset={offset}&order={order}&query={query}",
        "request": {
          "headers": {},
          "body": null
        },
  ...
  },
  {
    ...
    "resources": [
      ...
      },
      {
        ...
        "method": "GET",
        "url": "/api/v1/products?homepage=true",
        "request": {
          "headers": {},
          "body": null
        },
      ...
      },
      {
        ...
        "method": "GET",
        "url": "/api/v1/products?limit={limit}&offset={offset}&query={dotaz}",
        "request": {
          "headers": {},
          "body": null
        },
      ...
      },
      {
        ...
        "method": "GET",
        "url": "/api/v1/products?category={kategorie}&filter={filter}&limit={limit}&offset={offset}&order={order}",
        "request": {
          "headers": {},
          "body": null
        },
      ...
      },
      {
        ...
        "method": "GET",
        "url": "/api/v1/products?filter={filter}&limit={limit}&offset={offset}&order={order}&query={query}",
        "request": {
          "headers": {},
          "body": null
        },
